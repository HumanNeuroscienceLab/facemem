...
#+ setup
library(plyr)
subjects <- sub("_Questions_timing.txt", "", list.files("ts", pattern="_Questions_timing.txt"))
...
srois   <- list(postask=srois1, probatlas=srois2)
snames  <- list(postask=snames1, probatlas=snames2)
