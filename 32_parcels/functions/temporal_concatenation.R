...
migp <- function(Y, scale=TRUE, verbose=F, keep.subset=T) {
  ...
  if (keep.subset) {
    W <- W[1:n,]                # output just the required number of strongest spatial eigenvectors
  }
