...
logfile=$(pwd)/logs/group_${runtype}_${space}_${model}_`date +%Y-%m-%d_%H-%M`.txt
echo "" > $logfile
...
outdir="${grpdir}/${runtype}/task/${lruntype}_task_smoother.mema"

# suffix for subject input directory
suffix="${runtype}/task/smoother_preproc_${model}.reml"
